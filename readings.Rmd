...
<h2><strong>Influence of blood prostate specific antigen levels at age 60 on benefits and harms of prostate cancer screening: population based cohort study</strong></h2>
<a href="https://pubmed.ncbi.nlm.nih.gov/24682399/" class="link">Link to the article</a>
<span class="year">07/03/23</span>
<p> 
...
Apparently I read this article before, but there's value in reading papers multiple times to really understand what's going on. Funnily enough, I had similar questions as before. Need to ask someone about them.

<br>

Regarding this sentence and afterwards, how do binomial methods 'bias against...', and how do they help to 'obtain confidence intervals for risk differences': 'To obtain confidence intervals for risk differences, we used binomial methods.'

<br>

Inverse of the absolute risk reduction gives the number needed to screen (to prevent one person from developing metastatic disease?)
...
<strong>Nelson-Aalen Method</strong>

<strong>Fine-Gray Methdo</strong>

<strong>Scintigraphy</strong>: a technique in which a scintillation counter or similar detector is used with a radioactive tracer to obtain an image of a bodily organ or a record of its functioning
...
<div class="contact-wrapper contact-box">
<div class="contact-text">
<h2><strong>Impact of Acute Kidney Injury and Its Duration on Long-term Renal Function After Partial Nephrectomy</strong></h2>
<a href="https://www.sciencedirect.com/science/article/pii/S0302283819303562" class="link">Link to the article</a>
<span class="year">07/03/23</span>
<p> 
...
Do not know what the knots part of this line means, how to include knots? Also, I remember including cubic splines to accurately add node size for creating a model that predicts viable cancer or teratoma in testis project: 'Finally, we repeated the analyses including the duration of AKI as a continuous variable including nonlinear terms, using restricted cubic splines with knots at tertiles.'
...
<strong>Upstaging</strong>: progression of a disease to a higher stage

<strong>Sequelae</strong>: 

<strong>Ischemia</strong>: 
...
<div class="contact-wrapper contact-box">
<div class="contact-text">
<h2><strong>Total and Added Sugar Intake: Assessment in Eight Latin American Countries</strong></h2>
<a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5946174/" class="link">Link to the article</a>
<span class="year">07/01/23</span>
<p> 

This paper is hot trash. I did not enjoy reading it. The figures and tables do not tell me anything useful. There were many sentences that I wish I had not read, because I lost precious seconds of my life doing so. The first sentence of the abstract is a general statement that does not flow to the following ideas/thoughts.

<br>

One of the study aims is to verify adherence to WHO recommendations for total and added sugar intake. It's great that the WHO has these recommendations. However, discussion of the origins and validity of these recommendations would have added rigor rather than simply mentioning them.
...
<div class="contact-wrapper contact-box">
<div class="contact-text">
<h2><strong>Association of Geriatric Comanagement and 90-Day Postoperative Mortality Among Patients Aged 75 Years and Older With Cancer</strong></h2>
<a href="https://jamanetwork.com/journals/jamanetworkopen/article-abstract/2769503" class="link">Link to the article</a>
<span class="year">06/29/23</span>
<p> 
...
Adjusted for simply means include in model. When it's in the model, if you have the main covariate of interest, it estimates the effect of the main covariate while holding each other covariate constant

<br>

Interesting how in the methods it's split up into subsections.

<br>

This sentence in last paragraph of methods, doesn't it belong in results? Not really a method: 'A total of 834 patients (44.1%) were missing'

<br>

only read till end of results
...
<strong>perioperative</strong>: around time of surgery
...
<span class="year">06/28/23</span>
<p> 

<strong>Notes</strong>:

<strong>Study Objective</strong>: The objective of this study was to determine whether standard deviations (SDs) used in sample size calculations are smaller than those found in the resulting study sample, thereby leading to underpowered studies.

<br>

I do not understand this objective. How do smaller SDs in sample size calculations than those found in resulting study sample lead to underpowered studies? Perhaps smallers SDs in the calculations lead to smaller calculated sample size values. Will need to look into sample size calculations to see this in action. 

<br>

Paper suggests that a higher sample size lowers type II error (false negative), how does that work? High sample size = high power, how does this automatically lead to lower type II erorrs
...
<strong>Randomized Trials</strong>
...
<div class="contact-wrapper contact-box">
<div class="contact-text">
<h2><strong>Prognosis, Effect Modification, and Mediation</strong></h2>
<a href="https://pubmed.ncbi.nlm.nih.gov/29908877/" class="link">Link to the article</a>
<span class="year">06/28/23</span>
<p> 
...
Confused about whole para starting with 'One alternative to subgroup analysis...'. Why 2 multivar models, how does difference give benefit to patient? Why are multivariable models better than subgroup analysis?...

<br>

Confused about this whole para starting with 'It is straightforward to demonstrate that a prognostic factor'. Why if you keep absolute risk reduction constant does relative risk reduction vary, and vice versa? How does this demonstrate that a prognostic factor must also be a risk modifier?

<br>

Prognostic factors, effect modifying factors, and mediation factors all used in models to accurately predict risk of an outcome
...
<strong>Subgroup Analysis in Randomized Trials</strong>

<br>

<strong>Targeted Agents</strong> (e.g. cytotoxic agent)
...
<div class="contact-wrapper contact-box">
<div class="contact-text">
<h2><strong>Acupuncture for Chronic Pain: Update of an Individual Patient Data Meta-Analysis</strong></h2>
<a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5927830/" class="link">Link to the article</a>
<span class="year">06/27/23</span>
<p> 

<strong>Notes</strong>:

Have to look into <strong>Fixed effects</strong> and <strong>Random Effects</strong>: Fixed effects weights were calculated using inverse-variance weighting, and random effects weights were calculated using the DerSimonian and Laird method.
...
I find it quite annoying that they're mentioning stata commands used to conduct analyses. Those should be under the hood, no? The paper should just describe the analyses conducted.

<strong>Vocab</strong>:

<strong>Effect Size</strong>: large effect size means research study has practical significance 

<strong>Fixed Effects Analysis</strong>
...
<div class="contact-wrapper contact-box">
<div class="contact-text">
<h2><strong>Tail risk of contagious diseases</strong></h2>
<a href="https://www.nature.com/articles/s41567-020-0921-x" class="link">Link to the article</a>
<span class="year">06/27/23</span>
<p> 
...
Fat tails are deadly, they indicate events that don't happen to the masses, but can have grave consequence

<br>

Fatalities from infectious diseases are fat-tailed, those from car-accidents/heart attacks/ladder falls are thin-tailed

<br>

Read until third para under 'The tail-wags-the-dog effect'

<strong>Vocab</strong>:

<br>

<strong>Tail Risk of Contagious Diseases</strong>

<strong>Point Forecasts</strong>

<strong>Extreme Value Theory</strong>

<strong>Fréchet distribution</strong> 
...
Only read up to but not including discussion

<br>

I don't understand this sentence: The estimate of the treatment effect from ANCOVA was not importantly biased. How would the ANCOVA estimate be biased? How could we tell that it's biased? 

<br>

If sample size is large enough, say &ge;30 observations in each sample, t-test may be computed on almost any set of continuous data (central limit theorem)

<br>

<strong>Power</strong>: the proportion of times the null hypothesis is rejected (that is, the power)

<br>

"Where data are sampled from a normal distribution, the t-test has very slightly higher power than Mann-Whitney, the non-parametric alternative. However, when data are sampled from any one of a variety of non-normal distributions, Mann-Whitney is superior, often by a large amount."

<br>

<strong>Vocab</strong>:

<strong>Mann-Whitney</strong>: AKA Wilcoxon Rank Sum, statistical tool used to determine if there's significant difference between two independent groups of non-normally distributed data

<br>

<strong>Analysis of Covariance (ANCOVA)</strong>: statistical method that compares the means of a dependent variable across different groups while adjusting for or controlling the influence of one or more other continuous variables, known as covariates

<br>

<strong>iatrogenic</strong>: illness caused by treatment/medical intervention
